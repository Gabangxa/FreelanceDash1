...
- **Inline Notification Delivery**: Notifications are delivered synchronously in the same request/process that creates them via `NotificationDeliveryService` -- no message bus involved.
...
- **Notification System**: Inline notification delivery.
